...
$nmm_redux_args = array(
    ...
    'display_name'         => apply_filters('nmm_settings_display_name', 'ThorCommerce Settings'),
    ...
    'menu_type'            => 'menu',
    'allow_sub_menu'       => true,
    'menu_title'           => apply_filters('nmm_settings_menu_title', 'ThorCommerce '),
    'page_title'           => apply_filters('nmm_settings_page_title', 'ThorCommerce Settings'),
    ...
    'disable_save_warn'    => true,                    // Disable the save warning when a user 
    'page_priority'        => 56,
...
$nmmCustomerMessage = array(
    array(
        ...
        'desc' => 'This is the description of the VET payment for customers.',
    ),
);
...
foreach ($nmm_cryptos as $nmm_crypto) {    
	...
	$nmm_section = array(
	    ...
	    'fields'     => array(
	       array(
                ...
                'step'     => 0.1,
                'default'  => 0.0,
                'subtitle' => 'This only changes the VET asked for, the original fiat cost will still be displayed to the customer.',
                'desc' => 'This allows you to set the VET price from current market price for profit/discount.<br>(4.8 = 4.8% markup, -10.0 = 10% markdown)',
            ),
    	    array(
    ...
    if ($nmm_crypto->has_autopay()) {
        $nmm_section['fields'][] = array(
            ...
            'desc'     => '<div class="autopay-disclaimer-container">Please note Autopay Mode is still in <strong>beta</strong>. There is no guarantee every order will be processed correctly. We advise to wait until V.2.
    ...
    $nmm_section['fields'][] = array(
        ...
        'type'     => 'multi_text',
        'default'  => [''],
        'title'    => 'Your Wallet Address to Take Payment',
