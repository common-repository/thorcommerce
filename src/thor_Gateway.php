...
class NMM_Gateway extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title = 'VeChain (VET) Payment';
        $this->method_description = 'Allow customers to pay using VeChain (VET)';
    ...
    public function admin_options() {
        ...
        ?>
        <h2>VeChain (VET) Payments</h2>
        <div class="nmm-options">
            <table class="form-table">
                <?php $this->generate_settings_html(); ?>
            </table><!--/.form-table-->
            <a href=<?php echo get_site_url() . '/wp-admin/admin.php?page=' . NMM_REDUX_SLUG . '&tab=1'; ?>>ThorCommerce Plugin Settings</a>
        </div>
        <?php        
    }
    ...
    public function init_form_fields() {
        ...
        $generalSettings = array(
            ...
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => 'Enable VeChain (VET)) payments', 'woocommerce',
                'default' => 'yes',
                'class' => 'nmm-setting',
            ),
        );
