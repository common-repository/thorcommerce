...
Plugin Name: ThorCommerce
Plugin URI:  https://www.veriarti.io
Description: Accept VET payments in your WooCommerce Store
Author: VeriArti
Author URI: https://www.veriarti.io

Version: 1.0.0
License: GNU General Public License v3.0
License URI: http://www.gnu.org/licenses/gpl-3.0.html

redux-vendor-support.php
*/
require_once(plugin_basename('src/thor_Woo_field.php'));
require_once(plugin_basename('src/extra/redux-vendor-support.php'));
...
require_once(plugin_basename('src/thor_Settings.php'));
...
function NMM_init_gateways(){
    ...
    if (!class_exists('CashAddressCashAddress')) {
    ...
    // Http
    require_once(plugin_basename('src/thor_Exchange.php'));
    require_once(plugin_basename('src/thor_Blockchain.php'));

    // Database
    require_once(plugin_basename('src/thor_Carousel_Repo.php'));
    
    require_once(plugin_basename('src/thor_Hd_Repo.php'));
    require_once(plugin_basename('src/thor_Payment_Repo.php'));

    // Simple Objects
    require_once(plugin_basename('src/thor_Cryptocurrency.php'));
    require_once(plugin_basename('src/thor_Transaction.php'));
    
    // Business Logic
    require_once(plugin_basename('src/thor_Cryptocurrencies.php'));
    require_once(plugin_basename('src/thor_Carousel.php'));
    require_once(plugin_basename('src/thor_Hd.php'));    
    require_once(plugin_basename('src/thor_Payment.php'));

    // Misc
    require_once(plugin_basename('src/thor_Util.php'));
    require_once(plugin_basename('src/thor_Hooks.php'));
    require_once(plugin_basename('src/thor_Cron.php'));
    require_once(plugin_basename('src/thor_Admin.php'));
    require_once(plugin_basename('src/thor_Settings.php'));
    
    require_once(plugin_basename('src/thor_Validation.php'));

    // Core
    require_once(plugin_basename('src/thor_Gateway.php'));
